...
description: "LeeWay-governed Dockerfile Creation workflow. Use when a task requires dockerfile creation procedures, validation, and evidence."
license: MIT
metadata:
  authority: Creator/Human Authority > LeeWay Standards
  source-class: legacy-native-normalized
  canonical-path: skills/devops/dockerfile-creation/SKILL.md
---
/*
